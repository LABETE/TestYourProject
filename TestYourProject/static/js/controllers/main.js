...
angular.module('authApp')
  .controller('MainCtrl', function ($scope, $cookies, $state, djangoAuth) {
    ...
    $scope.goVerify = function(){
      $state.go("/verifyEmail/"+prompt("Please enter verification code"));
    }
    ...
    $scope.goConfirmReset = function(){
      $state.go("/passwordResetConfirm/"+prompt("Code 1")+"/"+prompt("Code 2"))
    }
